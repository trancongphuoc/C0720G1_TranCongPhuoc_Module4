...
public class BillController {
    ...
    // Danh sách Bill
    @GetMapping("/list")
    public String goBillList(@ModelAttribute AppUser appUser, Model model) {
        // Nếu chưa có thông tin. phải đăng ký thông tin customer
//        if (appUser.getCustomer() != null) {
//            if (appUser.getCustomer().getId() == null) {
...
//        }
        ...
        model.addAttribute("billList", billService.findAllByCustomer(appUser.getCustomer()));
    ...
    public String goPay(Model model,
        ...
        // Nếu appUser chưa có thông tin khách hàng
//        if (appUser.getCustomer() == null) {
//            return "redirect:/customer/";
//        }
...
//        billService.save(bill);
    ...
    public String goPay(@RequestParam Integer codeBorrow,
        ...
        if (billService.findByCodeBorrowAndCustomer(codeBorrow, appUser.getCustomer()) == null) {
